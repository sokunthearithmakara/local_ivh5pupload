...
$string['downloadstringsjson'] = 'Download strings JSON';
$string['downloadstringsjsontitle'] = 'Download translatable strings as a JSON file';
...
$string['translationfiles'] = 'Translation JSON files';
$string['translationfiles_help'] = 'Upload translated JSON files named after language codes (e.g. km.json, fr.json). The content will automatically load the translation matching the viewer\'s site language.';
